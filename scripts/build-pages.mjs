...
cpSync(resolve(root, 'receiver_video/dist'), resolve(outDir, 'receiver_video'), { recursive: true });
...
<html>
  ...
  <body><div class="card"><h1>QR Data Bridge</h1><a href="./sender/">Open Sender</a><a href="./receiver/">Open Receiver</a><a href="./receiver_video/">Open Replay Receiver Debugger</a></div></body>
</html>`
);

console.log('Prepared .pages-dist with sender/receiver/receiver_video apps.');
